...
export class AutoSearch {
  text = `Beginning fish, firmament give have make years. Divide you're. Fill light, him firmament cattle face 
  ...
  randomInterval$ = Observable
    .range(0, this.text.length)
    .concatMap(x => Observable.of(x).delay(Math.random() * 500));
