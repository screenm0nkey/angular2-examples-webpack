...
export class InjectComponent {
  constructor(public some1: SomeService, // defined in bootstrap.ts
    ...
    console.log("%c@Inject('jeffFactory') public jeffFactory", 'color:purple', jeffFactory);
  ...
  manuallyInject() {
    ...
    console.log('%cReflectiveInjector.resolveAndCreate()', 'color:purple', dependencies);
  }
}
