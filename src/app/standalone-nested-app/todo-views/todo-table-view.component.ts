...
@Component({
  ...
  template: `
    <div 
      class="todo-views-container-wrapper" 
      *ngIf="data.length > 0; else noContent">
      <div class="card-item" *ngFor="let dataItem of data">
        <ng-container 
          *ngIf="tmplRef; else noCard" [ngTemplateOutlet]="tmplRef"
          [ngTemplateOutletContext]="{dataschmater: dataItem}">
        </ng-container>
      </div>
    </div>
