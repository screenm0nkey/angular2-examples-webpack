  ...
  template: `
      <div class="miscellaneous">
          <nav>
              ...
              <a routerLink='./content-projection' routerLinkActive='active'>Content Projection (transclusion) using &lt;ng-content&gt; </a>
              <a routerLink='./rookie-mistakes' routerLinkActive='active'>@ContentChildren, ngAfterContentInit and
                  ngContent</a>
              ...
              <a routerLink='./chickens' routerLinkActive='active'>Dynamic Components, ExportAs, Renderer2, Directives
                  and ForkJoin()</a>
              ...
              <a routerLink='./notifications' routerLinkActive='active'>Notifications, Socket-io, @Input, @Output,
                  getters/setters</a>
