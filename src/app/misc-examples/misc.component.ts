...
@Component({
  template: `
    <div class='miscellaneous'>
      <nav>
        <a routerLink='./dep-injection' routerLinkActive='active' [routerLinkActiveOptions]='{ exact: true }'>Dependency
          Injection</a>
        ...
        <a routerLink='./chickens' routerLinkActive='active'>Dynamic Components, ExportAs, Renderer2, Directives and
          ForkJoin()</a>
