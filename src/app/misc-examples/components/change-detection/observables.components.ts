...
@Component({
  ...
  template: `
      ...
      <a href="http://blog.angular-university.io/how-does-angular-2-change-detection-really-work/" target="_blank">How does change detection really work</a>
      
      <p *ngIf="off">
        <strong>Change detection turned off for this component</strong>
      </p>
      <p>
        Even though the child view <code>ChildObsList</code> is set to "OnPush" it will still update as it's using observables.
